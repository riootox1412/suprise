...
function ftmuncul() {
  ...
  if (ftganti == 1 || ftganti == 2) {
    fotostiker.style = 'display:inline-flex;opacity:1;transform:scale(1);width:120px;height:120px;padding:none;background:none;box-shadow:none;border-radius:0;border:none';
  }
  if (ftganti == 9) {
    fotostiker.style = 'display:inline-flex;opacity:0;transform:scale(1);padding:none;background:none;box-shadow:none;border-radius:0;border:none';
  }
  if (ftganti == 10) {
    fotostiker.src = fotostikerA.src;
    fotostiker.style = 'display:inline-flex;opacity:1;transform:scale(1);width:120px;height:120px;padding:none;background:none;box-shadow:none;border:none;border-radius:0;';
  }
}
function fthilang() {
...
function bqmuncul() {
  ...
  bq.style = 'position:relative;opacity:1;visibility:visible;margin-top:0;transform: scale(1);';
